          ...
          chrome.storage.local.get(
            ...
            function (itemsLocal) {
              const actualCode = [
                ...
                'window.color_slot_removed_history_tran = "' + itemsSync.color_slot_removed_history_tran + '";',
                'window.color_slot_removed_history_tran_show = ' + itemsSync.color_slot_removed_history_tran_show + ';',
                'window.color_slot_placed_history_tran = "' + itemsSync.color_slot_placed_history_tran + '";',
                'window.color_slot_placed_history_tran_show = ' + itemsSync.color_slot_placed_history_tran_show + ';',
